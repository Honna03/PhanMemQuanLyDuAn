        ...
        private async void AddTaskButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                var task = new CongViec
                {
                    ...
                    CvBatDau = TaskStartDatePicker.SelectedDate.HasValue ? DateOnly.FromDateTime(TaskStartDatePicker.SelectedDate.Value) : null,
                    CvKetThuc = TaskStartDatePicker.SelectedDate.HasValue ? DateOnly.FromDateTime(TaskStartDatePicker.SelectedDate.Value) : null,
